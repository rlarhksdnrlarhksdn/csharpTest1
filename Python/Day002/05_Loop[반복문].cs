...
######################################################################################
# # 실습1
# # 1 부터 100 사이의 수 중 짝수 만 표현하는 로직을 구현해 보세요
######################################################################################
...
######################################################################################
# # 실습2
# # 1부터 100 까지의 수 중 3 의 배수 인 숫자의 모든 합을 구하세요
######################################################################################
...
#     if 30 < num < 40:
#         print(num, ' 은 합산되지 않고 다음 for의 값을 처리합니다.')
#         continue
#     elif num % 3 ==0:
#         sum += num
#     elif num == 77:
...
#     # student +=1 # 반드시 루프를 종료 시킬수 있는조건의 변화가 필요하다.
#     student +=1
#     if 10 < student < 15:
#         continue
...
# while True :
#     print(datetime.now())
#     time.sleep(1) # 1초 C# 1000

# # 특정 조건을 만족할 경우 무한 루프를 빠져나오는 로직을 구현
# # 종료해야 하는 범위가 지정되어 있지 않는 프로세스의 종료를 구현하고자 할때
...
######################################################################################
# # 실습
# # While 문을 사용하여 1 에서 200 까지 모든 3의 배수 를 모두 표현하고 누적 합계를 출력 하세
######################################################################################
# num = 1
# sum = 0
# while num <= 200:
...
######################################################################################
# # 실습
# # 아래와 같은 별 표 삼각형을 그리는 로직을 구현 해 보세요
######################################################################################
# for y in range(1,11):
#     for x in range(10-y):
#         print(' ', end='')
...
#         print(' ', end='')
#     for z in range(1+(2*y)):
#         print('*', end='')
#     print()

######################################################################################
# # 실습
# #  0 부터 9999 까지 의 수 중 6 이 들어가지 않은 수 의 개수를 구하세요
######################################################################################
# cnt =0
